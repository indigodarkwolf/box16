...
- Debian: `sudo apt-get install libgtk-3-dev libsdl2-dev libsdl2-image-dev`
- Fedora 33: `sudo dnf install SDL2-devel SDL2_image-devel`
- Raspbian: `sudo apt-get install libgtk-3-dev libsdl2-dev libsdl2-image-dev`
