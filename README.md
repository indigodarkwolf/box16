...
- Debian: `sudo apt-get install libglew-dev libgtk-3-dev libsdl2-dev`
- Fedora 33: `sudo dnf install glew-devel SDL2-devel`
- Raspbian: `sudo apt-get install libglew-dev libgtk-3-dev libsdl2-dev`
