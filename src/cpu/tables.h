...
/* 2 */        jsr, and_op,    nop,    nop,    bit, and_op,    rol,   rmb2,    plp, and_op,    rol,    nop,    bit, and_op,    rol,   bbr2, /* 2 */
/* 3 */        bmi, and_op, and_op,    nop,    bit, and_op,    rol,   rmb3,    sec, and_op,    dec,    nop,    bit, and_op,    rol,   bbr3, /* 3 */
